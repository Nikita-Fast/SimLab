...
def f():
	...
	module_3_QAM_Demodulator = qam_demod.QAMDemodulator(bits_per_symbol=4, constellation=None, mode='hard')
	id_to_module[3] = module_3_QAM_Demodulator
	...
	module_6_BER_Plotter = ber_plotter.save
	id_to_module[6] = module_6_BER_Plotter
	id_to_descriptor[6] = ber_plotter
