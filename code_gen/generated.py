...
def f():
	...
	module_0_AWGNChannel = awgn_descr.AWGNChannel(information_bits_per_symbol=4)
	...
	module_4_Binary_Generator = bin_gen.gen_binary_data
	id_to_module[4] = module_4_Binary_Generator
	id_to_descriptor[4] = bin_gen
	module_5_QAM_Modulator = qam_mod.QAMModulator(bits_per_symbol=4, constellation=None)
	id_to_module[5] = module_5_QAM_Modulator
	id_to_descriptor[5] = qam_mod
