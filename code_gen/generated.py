...
module_0_QAMModulator = qam_mod.QAMModulator(bits_per_symbol=4, constellation=None)
id_to_module['0'] = module_0_QAMModulator
id_to_descriptor['0'] = qam_mod
module_1_QAMDemodulator = qam_demod.QAMDemodulator(bits_per_symbol=4, constellation=None, mode='hard')
id_to_module['1'] = module_1_QAMDemodulator
id_to_descriptor['1'] = qam_demod
module_2_AWGNChannel = awgn_descr.AWGNChannel(information_bits_per_symbol=4, ebn0_db=12)
id_to_module['2'] = module_2_AWGNChannel
id_to_descriptor['2'] = awgn_descr
module_3_BinaryGenerator = bin_gen.gen_binary_data
id_to_module['3'] = module_3_BinaryGenerator
